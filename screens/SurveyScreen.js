...
export default function SurveyScreen() {
    ...
    <KeyboardAvoidingView style={{flex:1}}>
      <ScrollView style={{marginTop:'1%'}}>
        ...
        <AppButton title={'Clear'} onPress={()=>{setIncome(undefined);Alert.alert("Field cleared")}}/>
        ...
        <AppButton title={'Clear'} onPress={()=>{setExpense(undefined);Alert.alert("Field cleared")}}/>
